    ...
    _setUpHandlerEvents: function(handle, xMod, yMod) {
        ...
        function onMouseDown(event) {
            ...
            function onMouseMove(event) {
                ...
                curX = event.originalEvent.clientX;
                curY = event.originalEvent.clientY;
                self._render();
            }
